package melby.demo.gcp.functions;
...
public class BucketEventListener implements CloudEventsFunction {
    private static final Logger logger = Logger.getLogger(BucketEventListener.class.getName());
